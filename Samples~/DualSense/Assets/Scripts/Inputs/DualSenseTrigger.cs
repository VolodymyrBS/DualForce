...
namespace DualSenseSample.Inputs
{
    ...
    public class DualSenseTrigger : AbstractDualSenseBehaviour
    {
        ...
        private DualSenseTriggerState last_leftTriggerState;
        private DualSenseTriggerState last_rightTriggerState;
        ...
        private void Update()
        {
            ...
            if (!BitComparer.Equals(leftTriggerState, last_leftTriggerState))
            {
                state.LeftTrigger = leftTriggerState;
                last_leftTriggerState = leftTriggerState;
                update = true;
            }
            
            if (!BitComparer.Equals(rightTriggerState, last_rightTriggerState))
            {
                state.RightTrigger = rightTriggerState;
                last_leftTriggerState = rightTriggerState;
                update = true;
            }
